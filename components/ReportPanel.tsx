...
import { AlertTriangle, AlertOctagon, Info, Download, RefreshCw, AlertCircle, FileText, Loader2, Bug, Copy, Check, X, Lightbulb, Sparkles } from 'lucide-react';
      ...
      <div className="p-4 border-b border-slate-200 flex justify-between items-center bg-white z-10 shrink-0">
        <div className="overflow-hidden mr-2">
          ...
          <div className="flex items-center mt-0.5 space-x-2">
            ...
            {report.modelUsed && (
              <span 
                className="flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full font-medium bg-purple-50 text-purple-700 border border-purple-200"
                title={`Generated by ${report.modelUsed}`}
              >
                <Sparkles size={10} />
                {report.modelUsed}
              </span>
